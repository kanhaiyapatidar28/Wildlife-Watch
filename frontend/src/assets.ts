...
export const IMAGES = {
  ...
  branding: {
    ...
    homepageHeroBg: {
      ...
      title: 'Global Satellite Habitat Radar Background',
      description: 'High-altitude multi-spectral composite showcasing equatorial and sub-tropical forest biomes',
      category: 'branding' as const,
      url: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1920&q=80',
      thumbnailUrl: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=480&q=80',
      alt: 'Earth Observation Satellite Telemetry Background',
      width: 1920,
      height: 1080,
      aspectRatio: '16:9',
      attribution: 'NASA / Copernicus Sentinel Earth Observation',
      tags: ['hero', 'space', 'earth-observation', 'telemetry'],
    },
    rangerInsignia: {
